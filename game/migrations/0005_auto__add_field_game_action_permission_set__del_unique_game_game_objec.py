...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Game.action_permission_set'
        db.add_column(u'game_game', 'action_permission_set',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='games', to=orm['game.ActionPermissionSet']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Game.action_permission_set'
        db.delete_column(u'game_game', 'action_permission_set_id')
    ...
    models = {
        ...
        u'game.game': {
            'Meta': {'unique_together': "(('game_object_set', 'game_object_relationship_set', 'game_rules', 'display_ruleset', 'action_permission_set'), ('name',))", 'object_name': 'Game'},
