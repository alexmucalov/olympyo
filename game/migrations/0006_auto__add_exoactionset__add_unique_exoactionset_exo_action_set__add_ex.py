...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Game', fields ['game_object_set', 'game_object_relationship_set', 'game_rules', 'display_ruleset', 'action_permission_set']
        db.delete_unique(u'game_game', ['game_object_set_id', 'game_object_relationship_set_id', 'game_rules_id', 'display_ruleset_id', 'action_permission_set_id'])

        # Adding model 'ExoActionSet'
        db.create_table(u'game_exoactionset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('exo_action_set', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'game', ['ExoActionSet'])

        # Adding unique constraint on 'ExoActionSet', fields ['exo_action_set']
        db.create_unique(u'game_exoactionset', ['exo_action_set'])

        # Adding model 'ExoAction'
        db.create_table(u'game_exoaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('exo_action_set', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exo_actions', to=orm['game.ExoActionSet'])),
            ('exo_action', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exo_actions', to=orm['game.ArchAction'])),
            ('parameters', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('affected', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exo_actions', null=True, to=orm['game.GameObject'])),
            ('turn', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'game', ['ExoAction'])

        # Adding unique constraint on 'ExoAction', fields ['exo_action_set', 'exo_action', 'parameters', 'affected', 'turn']
        db.create_unique(u'game_exoaction', ['exo_action_set_id', 'exo_action_id', 'parameters', 'affected_id', 'turn'])

        # Adding field 'Game.exo_action_set'
        db.add_column(u'game_game', 'exo_action_set',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='games', null=True, to=orm['game.ExoActionSet']),
                      keep_default=False)

        # Adding unique constraint on 'Game', fields ['game_object_set', 'game_object_relationship_set', 'game_rules', 'display_ruleset', 'action_permission_set', 'exo_action_set']
        db.create_unique(u'game_game', ['game_object_set_id', 'game_object_relationship_set_id', 'game_rules_id', 'display_ruleset_id', 'action_permission_set_id', 'exo_action_set_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Game', fields ['game_object_set', 'game_object_relationship_set', 'game_rules', 'display_ruleset', 'action_permission_set', 'exo_action_set']
        db.delete_unique(u'game_game', ['game_object_set_id', 'game_object_relationship_set_id', 'game_rules_id', 'display_ruleset_id', 'action_permission_set_id', 'exo_action_set_id'])

        # Removing unique constraint on 'ExoAction', fields ['exo_action_set', 'exo_action', 'parameters', 'affected', 'turn']
        db.delete_unique(u'game_exoaction', ['exo_action_set_id', 'exo_action_id', 'parameters', 'affected_id', 'turn'])

        # Removing unique constraint on 'ExoActionSet', fields ['exo_action_set']
        db.delete_unique(u'game_exoactionset', ['exo_action_set'])

        # Deleting model 'ExoActionSet'
        db.delete_table(u'game_exoactionset')

        # Deleting model 'ExoAction'
        db.delete_table(u'game_exoaction')

        # Deleting field 'Game.exo_action_set'
        db.delete_column(u'game_game', 'exo_action_set_id')

        # Adding unique constraint on 'Game', fields ['game_object_set', 'game_object_relationship_set', 'game_rules', 'display_ruleset', 'action_permission_set']
        db.create_unique(u'game_game', ['game_object_set_id', 'game_object_relationship_set_id', 'game_rules_id', 'display_ruleset_id', 'action_permission_set_id'])
