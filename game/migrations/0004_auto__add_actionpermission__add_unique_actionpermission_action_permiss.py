...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActionPermission'
        db.create_table(u'game_actionpermission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('action_permission_set', self.gf('django.db.models.fields.related.ForeignKey')(related_name='action_permissions', to=orm['game.ActionPermissionSet'])),
            ('permitted_initiator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='permitted_initiator_actions', to=orm['game.ArchGameObject'])),
            ('action', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.ArchAction'])),
            ('permitted_affected', self.gf('django.db.models.fields.related.ForeignKey')(related_name='permitted_affected', to=orm['game.ArchGameObject'])),
        ))
        db.send_create_signal(u'game', ['ActionPermission'])

        # Adding unique constraint on 'ActionPermission', fields ['action_permission_set', 'permitted_initiator', 'action', 'permitted_affected']
        db.create_unique(u'game_actionpermission', ['action_permission_set_id', 'permitted_initiator_id', 'action_id', 'permitted_affected_id'])

        # Adding model 'ActionPermissionSet'
        db.create_table(u'game_actionpermissionset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('action_permission_set', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'game', ['ActionPermissionSet'])

        # Adding unique constraint on 'ActionPermissionSet', fields ['action_permission_set']
        db.create_unique(u'game_actionpermissionset', ['action_permission_set'])


    def backwards(self, orm):
        # Removing unique constraint on 'ActionPermissionSet', fields ['action_permission_set']
        db.delete_unique(u'game_actionpermissionset', ['action_permission_set'])

        # Removing unique constraint on 'ActionPermission', fields ['action_permission_set', 'permitted_initiator', 'action', 'permitted_affected']
        db.delete_unique(u'game_actionpermission', ['action_permission_set_id', 'permitted_initiator_id', 'action_id', 'permitted_affected_id'])

        # Deleting model 'ActionPermission'
        db.delete_table(u'game_actionpermission')

        # Deleting model 'ActionPermissionSet'
        db.delete_table(u'game_actionpermissionset')
