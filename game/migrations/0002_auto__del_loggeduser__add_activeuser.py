...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'game_activeuser', (
            ...
            ('launched', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'game', ['ActiveUser'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'game_activeuser')
