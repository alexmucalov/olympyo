"""
Django settings for olympyo project.
...
TEMPLATE_DIRS = (
    '{BASE_DIR}/templates'.format(BASE_DIR=BASE_DIR),
)
...
ROOT_URLCONF = 'olympyo.urls'

WSGI_APPLICATION = 'olympyo.wsgi.application'
